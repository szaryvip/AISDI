...
def test_merge_sorting_5(benchmark):
    new_list = []
    for i in range(100):
        new_list.append(randint(0, 5363))
    result = benchmark(merge_sort, new_list)
    assert result == sorted(new_list)


def test_merge_sorting_6(benchmark):
    new_list = []
    for i in range(1000):
...
def test_merge_sorting_7(benchmark):
    result = benchmark(merge_sort, [])
    assert result == []


def test_merge_sorting_8(benchmark):
    result = benchmark(merge_sort, [4, 4, 4, 4, 4])
    assert result == [4, 4, 4, 4, 4]


def test_merge_sorting_9(benchmark):
    result = benchmark(merge_sort, [-20, -10, 0, 10, 20])
    assert result == [-20, -10, 0, 10, 20]

def test_merge_sorting_10(benchmark):
    result = benchmark(merge_sort, [20, 10, 0, -10, -20])
    assert result == [-20, -10, 0, 10, 20]
